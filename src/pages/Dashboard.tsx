...
import { Target, TrendingUp, UserPlus, Package } from 'lucide-react';

const stats = [
  { name: 'Customer Acquisition', value: '2.4K', icon: UserPlus, change: '+24%', changeType: 'increase' },
  { name: 'Revenue Growth', value: '$89K', icon: TrendingUp, change: '+12%', changeType: 'increase' },
  { name: 'Conversion Rate', value: '3.2%', icon: Target, change: '+0.8%', changeType: 'increase' },
